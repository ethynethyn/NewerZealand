...
public class QuestLogUI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (scroll > 0f) ShowPage(currentPage - 1); // scroll up
        else if (scroll < 0f) ShowPage(currentPage + 1); // scroll down
    }
    ...
    private void BuildPages()
    {
        ...
        // --- INCOMPLETE QUESTS: reuse previous working page overflow logic ---
